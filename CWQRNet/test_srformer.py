# model: LCFormer
# LCFormer: Permuted Self-Attention for Single Image Super-Resolution
...
class dwconv(nn.Module):
    def __init__(self,hidden_features):
        ...
        self.act2 = nn.GELU()
        self.dw = nn.Conv2d(hidden_features, hidden_features, 5, 1, 2, groups=hidden_features, bias=False)
    ...
    def __init__(self,
        ...
        self.blocks = nn.ModuleList([
            PSA_Block(
                ...
                shift_size=0 if (0 % 2 == 0) else window_size // 2,
                mlp_ratio=mlp_ratio,
                qkv_bias=qkv_bias,
                qk_scale=qk_scale,
                drop=drop,
...
class LCFormer(nn.Module):
    r""" LCFormer
        A PyTorch implement of : `LCFormer: Permuted Self-Attention for Single Image Super-Resolution`, based on Swin Transformer.
